...
export const metadata: Metadata = {
  ...
  description:
    'IICRC restoration training for Australian data centres. Water damage restoration, structural drying and fire & smoke restoration courses for water damage prevention, climate control recovery, and fire suppression system response.',
  keywords: [
...
const whyCards = [
  ...
  },
  {
    ...
    description:
      "Post-suppression cleanup requires specialist knowledge. CARSI's CEC-accredited fire and smoke restoration training covers residue removal, air quality restoration, and equipment assessment after clean agent or water mist activation.",
    color: '#ed9d24',
  },
];
