...
export default function PrivacyPage() {
  return (
    <LegalDocumentShell title="Privacy Policy" updated="22 March 2026">
      <section>
        <h2 className={marketingLegalH2}>1. Overview</h2>
        <p>
          CARSI Pty Ltd (&ldquo;CARSI&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;)
          is committed to protecting your privacy. This Privacy Policy explains how we collect, use,
          disclose, and safeguard your personal information in accordance with the Australian Privacy
          Principles (APPs) under the Privacy Act 1988 (Cth).
        </p>
      </section>

      <section>
        <h2 className={marketingLegalH2}>2. Information We Collect</h2>
        <h3 className={marketingLegalH3}>2.1 Information You Provide</h3>
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Account information: name, email address, password, IICRC certification number (optional)
          </li>
        ...
        <h3 className={marketingLegalH3}>2.2 Information Collected Automatically</h3>
        <ul className="list-disc space-y-2 pl-6">
      ...
      <section>
        <h2 className={marketingLegalH2}>3. How We Use Your Information</h2>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            Show optional, aggregated monthly learning recognition on an in-app board (anonymous by
            default; you may choose an optional public label in your profile — we never display your
            email or account name there)
          </li>
      ...
      <section>
        <h2 className={marketingLegalH2}>4. Disclosure of Information</h2>
        <p>We may share your personal information with:</p>
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong className={marketingTextStrong}>IICRC:</strong> We report CEC completions (name,
            certification number, course completed, date) to IICRC for credit recording purposes.
          </li>
          <li>
          ...
          <li>
            <strong className={marketingTextStrong}>Business transfers:</strong> In connection with a
      ...
      <section>
        <h2 className={marketingLegalH2}>5. Data Security</h2>
        <p>
      ...
      <section>
        <h2 className={marketingLegalH2}>6. Data Retention</h2>
        <p>
          We retain your personal information for as long as your account is active or as needed to
          provide you services. We may retain certain information after account closure for:
        </p>
        <ul className="list-disc space-y-2 pl-6">
      ...
      <section>
        <h2 className={marketingLegalH2}>7. Cookies</h2>
      ...
      <section>
        <h2 className={marketingLegalH2}>8. Your Rights</h2>
        <p>Under Australian privacy law, you have the right to:</p>
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong className={marketingTextStrong}>Access:</strong> Request a copy of the personal
            information we hold about you.
          </li>
          <li>
            <strong className={marketingTextStrong}>Correction:</strong> Request correction of
            inaccurate or incomplete information.
          </li>
          <li>
            <strong className={marketingTextStrong}>Deletion:</strong> Request deletion of your
            personal information (subject to legal retention requirements).
          </li>
          <li>
            <strong className={marketingTextStrong}>Complaint:</strong> Lodge a complaint with the
      ...
      <section>
        <h2 className={marketingLegalH2}>10. Children&apos;s Privacy</h2>
        <p>
      ...
      <section>
        <h2 className={marketingLegalH2}>11. Changes to This Policy</h2>
        <p>
          We may update this Privacy Policy from time to time. We will notify you of material changes
          by posting a notice on the Service or by email. Your continued use of the Service after
          changes are posted constitutes acceptance of the updated Policy.
        </p>
      </section>

      <section>
        <h2 className={marketingLegalH2}>12. Contact Us</h2>
        <p>For privacy-related enquiries or to exercise your rights, contact our Privacy Officer:</p>
