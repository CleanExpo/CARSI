...
const SYSTEM_PROMPT = [
  ...
  '4. NEVER state or imply that CARSI delivers IICRC certification. CARSI issues its own CARSI',
  '   designations and (separately) earns IICRC CECs; do not state or imply any CEC hours in the content.',
