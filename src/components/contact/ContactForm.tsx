    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          // @ts-expect-error WebMCP attribute — W3C draft, not yet in React types
          toolparamdescription="Free-text enquiry (max 3000 chars). Mention your IICRC discipline if applicable, and whether the enquiry is for individual or group/corporate enrolment."
        />
      </div>
