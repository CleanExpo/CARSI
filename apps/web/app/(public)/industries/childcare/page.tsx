...
import { ArrowRight, Shield, Baby, Droplets } from 'lucide-react';
...
async function getIndustryCourses() {
  ...
  try {
    ...
    const combined = [];
    for (const c of [...crtCourses, ...amrtCourses, ...wrtCourses]) {
      if (!seen.has(c.id)) {
        seen.add(c.id);
        combined.push(c);
      }
          ...
          <div className="animate-slide-up">
            ...
            <div
              ...
              style={{
                ...
                color: '#e91e63',
                boxShadow: '0 0 12px rgba(233,30,99,0.1)',
              }}
            >
            ...
            >
              Childcare Hygiene &
              <br />
              <span className="text-gradient">Infection Control</span>
            </h1>
            ...
            >
              NQF-compliant training for childcare centres across Australia. Equip your cleaning and
              maintenance staff with IICRC-recognised credentials in carpet restoration, microbial
              remediation, and water damage response.
            </p>

            {/* Discipline pills */}
            <div className="mb-10 flex flex-wrap gap-2">
              <DisciplinePill code="AMRT" label="Applied Microbial Remediation" color="#e91e63" />
              <DisciplinePill code="CRT" label="Carpet Restoration" color="#9c27b0" />
              <DisciplinePill code="WRT" label="Water Damage Restoration" color="#673ab7" />
            </div>
          </div>

          {/* Stats row */}
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <GlassStatCard value="16,000+" label="Approved Centres" />
            <GlassStatCard value="NQF" label="Quality Framework" />
        ...
        <section className="py-16" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10">
              ...
              >
                Why Childcare Centres Choose CARSI
              </p>
              <h2
                className="font-display text-3xl font-bold"
                style={{ color: 'rgba(255,255,255,0.92)' }}
              >
                Built for <span className="text-gradient">child safety</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'IICRC training directly supports Health & Safety requirements under the National Quality Standard. Aim for "Exceeding" at your next ACECQA assessment.',
                  color: '#e91e63',
                ...
                },
                {
                  ...
                  desc: 'Train staff to maintain carpet in indoor play areas, reading corners, and nap rooms. Proper hygiene directly impacts child health.',
                  color: '#9c27b0',
                ...
                },
                {
                  ...
                  desc: 'Water damage from bathrooms, wet rooms, and water play areas is common. IICRC-certified staff respond correctly the first time.',
                  color: '#ed9d24',
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              <p
                ...
                style={{ color: 'rgba(255,255,255,0.3)' }}
              >
                Childcare-Relevant Courses
              </p>
              <h2
                className="font-display text-3xl font-bold"
                style={{ color: 'rgba(255,255,255,0.92)' }}
              >
                AMRT, CRT &amp; WRT Training
              </h2>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 60px rgba(233,30,99,0.08), inset 0 1px 0 rgba(255,255,255,0.08)',
              }}
            >
              <div
              ...
              <p
                ...
                style={{ color: 'rgba(255,255,255,0.3)' }}
              >
                Childcare Compliance Training
              </p>
              <h2
                className="font-display relative z-10 mb-4 text-4xl font-bold"
                style={{ color: 'rgba(255,255,255,0.95)' }}
              >
                Childcare Compliance Bundle <span className="text-gradient">$195</span>
              </h2>
              <p
                className="relative z-10 mx-auto mb-8 max-w-lg text-base"
                style={{ color: 'rgba(255,255,255,0.5)' }}
              >
                AMRT Infection Control + CRT Carpet Basics + WRT Fundamentals. Minimal roster
                disruption — 2-4 hour self-paced modules.
              </p>
