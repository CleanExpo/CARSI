...
import { ArrowRight, Building, Shield, Droplets, Scale } from 'lucide-react';
...
async function getIndustryCourses() {
  ...
  try {
    ...
    const combined = [];
    for (const c of [...amrtCourses, ...wrtCourses, ...crtCourses, ...asdCourses]) {
      if (!seen.has(c.id)) {
        seen.add(c.id);
        combined.push(c);
      }
          ...
          <div className="animate-slide-up">
            ...
            <div
              ...
              style={{
                ...
                color: '#673ab7',
                boxShadow: '0 0 12px rgba(103,58,183,0.1)',
              }}
            >
            ...
            >
              Residential Tenancies Act compliance training for property managers and strata
              managers. IICRC credentials reduce tribunal disputes and differentiate your agency in
              competitive markets.
            </p>

            {/* Discipline pills */}
            <div className="mb-10 flex flex-wrap gap-2">
              <DisciplinePill code="AMRT" label="Applied Microbial Remediation" color="#673ab7" />
              <DisciplinePill code="WRT" label="Water Damage Restoration" color="#512da8" />
              <DisciplinePill code="CRT" label="Carpet Repair Technology" color="#4527a0" />
              <DisciplinePill code="ASD" label="Applied Structural Drying" color="#311b92" />
            </div>
          </div>

          {/* Stats row */}
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <GlassStatCard value="12,000+" label="Property Agencies" />
            <GlassStatCard value="RTA" label="Compliance" />
        ...
        <section className="py-16" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10">
              ...
              >
                Why Property Managers Choose CARSI
              </p>
              <h2
                className="font-display text-3xl font-bold"
                style={{ color: 'rgba(255,255,255,0.92)' }}
              >
                Built for <span className="text-gradient">tribunal defence</span>
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Verifiable assessment credentials provide defensible documentation in NCAT/VCAT hearings. Reduce mould and carpet disputes with standards-based evidence.',
                  color: '#673ab7',
                  glow: 'rgba(103,58,183,0.15)',
                },
                {
                  Icon: Shield,
                  title: 'RTA Compliance',
                  desc: 'Mould is a habitability issue under all state Residential Tenancies Acts. Trained managers avoid regulatory breaches and landlord liability.',
                  color: '#512da8',
                  glow: 'rgba(81,45,168,0.15)',
                },
                {
                  Icon: Droplets,
                  title: 'Insurance Claims',
                  desc: 'Defensible, standards-based documentation for water damage and mould insurance claims. Win management contracts with qualified credentials.',
                  color: '#ed9d24',
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              <p
                ...
                style={{ color: 'rgba(255,255,255,0.3)' }}
              >
                Property Management-Relevant Courses
              </p>
              <h2
                className="font-display text-3xl font-bold"
                style={{ color: 'rgba(255,255,255,0.92)' }}
              >
                AMRT, WRT, CRT &amp; ASD Training
              </h2>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 60px rgba(103,58,183,0.08), inset 0 1px 0 rgba(255,255,255,0.08)',
              }}
            >
              <div
              ...
              <h2
                ...
                style={{ color: 'rgba(255,255,255,0.95)' }}
              >
                Property Bundle <span className="text-gradient">$195</span>
              </h2>
              <p
                className="relative z-10 mx-auto mb-8 max-w-lg text-base"
                style={{ color: 'rgba(255,255,255,0.5)' }}
              >
                AMRT Mould Basics + WRT Water Damage + CRT Carpet Assessment. Agency bulk pricing
                available for 10+ property managers.
              </p>
