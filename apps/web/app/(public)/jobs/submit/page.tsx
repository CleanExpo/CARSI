      ...
      <div className="mx-auto max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="space-y-5">
            <h2 className="text-lg font-semibold text-white/80 border-b border-white/[0.06] pb-2">
              Job Details
            </h2>
          ...
          <section className="space-y-5">
            <h2 className="text-lg font-semibold text-white/80 border-b border-white/[0.06] pb-2">
              How to Apply
              <span className="ml-2 text-sm font-normal text-white/30">(at least one required)</span>
            </h2>
            <div>
          ...
          <p className="text-center text-xs text-white/30">
            By submitting, you confirm this listing is accurate and you have authority to post on behalf of the company.
