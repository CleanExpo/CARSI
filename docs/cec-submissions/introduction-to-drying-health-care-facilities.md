# IICRC CEC Course Approval Submission — Introduction to Drying Health Care Facilities
...
- **Course page:** https://www.carsi.com.au/courses/introduction-to-drying-health-care-facilities
- **Level:** Foundational
...
**Summary.** Understand the design factors, building systems, infection control risks, and standards involved in drying water-damaged health care facilities.

**Learning objectives / curriculum outline.**

- Module — Special Design Considerations: Special Design Considerations — Reading
- Module — Unique Building Systems: Unique Building Systems — Reading
- Module — Infection Control Risks: Infection Control Risks — Reading
- Module — Maintaining Critical Operations: Maintaining Critical Operations — Reading
- Module — Remediation Standards: Remediation Standards — Reading
